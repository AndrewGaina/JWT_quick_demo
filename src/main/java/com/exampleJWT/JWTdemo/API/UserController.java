package com.exampleJWT.JWTdemo.API;
...
public class UserController {
    ...
    public ResponseEntity<?> addRoleToUser(@RequestBody RoleAndUser roleAndUser){
        userService.addRoleToUser(roleAndUser.getUsername(),
                roleAndUser.getRoleName());
        ...
        if (authorizationHeader != null && authorizationHeader.startsWith("Bearer ")){
            try {
                ...
                String access_token = JWT.create()
                        ...
                        .withClaim("roles", userApp.getRoles().stream().map(Role::getName)
